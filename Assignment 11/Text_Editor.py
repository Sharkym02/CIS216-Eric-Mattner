...
# The format menu allows the user to change the color of the text and font
...
fontMenu.add_command(label="Arial", command=set_arial)
fontMenu.add_command(label="Comic Sans MS", command=set_comic)
fontMenu.add_command(label="Courier New", command=set_courier)
fontMenu.add_command(label="Times New Roman", command=set_times)
menuBar.add_cascade(label="Format", menu=formatMenu)

helpMenu = tk.Menu(menuBar, tearoff=0)
aboutMenu = tk.Menu(helpMenu, tearoff=0)
helpMenu.add_cascade(label="About", menu=aboutMenu)
aboutMenu.add_cascade(label="This program allows you to write any text in the typing area, contains cut copy and paste features, allows you to save and open text files, and allows you to change the color and font of your text")
