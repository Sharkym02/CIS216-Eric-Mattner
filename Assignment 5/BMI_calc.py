...
# Ask user which units to use and check if input is valid
units = input('Enter "1" if you would like to use metric units, enter "2" if you would like to use imperial\n')
if units.isdigit() == False:
        raise TypeError("Please input an integer 1 or 2")

units = int(units)

if units != 1 and units != 2:
        raise ValueError("Please input an integer 1 or 2")
