...
# This function returns the amount of money the employee should be paid calculated using their wage, hours worked, and commission
    def pay_out(self):
...
# This function returns the amount of money the employee should be paid calculated using their salary and number of employees managed
    def pay_out(self):
